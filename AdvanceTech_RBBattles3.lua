...
Section:NewButton("Shopping Wars 2", "idk", function()
...
Section:NewButton("Funky Friday", "Go to the end of the obby", function()
...
local Section = Tab:NewSection("Credit To Tora for the script")
